...
class Event(BaseModel):
    ...
    price: int | None = Field(description="Offer price, or known charge for a booked coaching; null means unconfirmed")
    payment_state: str | None = Field(default=None, description="Payment status of the current booking, if applicable")
