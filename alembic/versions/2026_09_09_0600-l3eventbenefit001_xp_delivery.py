...
def upgrade() -> None:
    ...
    op.create_table("events_benefits",
        ...
        sa.UniqueConstraint("source_kind", "source_id", "role"), mysql_collate="utf8mb4_bin")
    op.create_table("events_benefit_observations",
        ...
        sa.Column("result", sa.JSON(), nullable=False), mysql_collate="utf8mb4_bin")
