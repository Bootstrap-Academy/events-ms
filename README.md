<p>
  ...
  [![CI](https://github.com/Bootstrap-Academy/events-ms/actions/workflows/ci.yml/badge.svg)](https://github.com/Bootstrap-Academy/events-ms/actions/workflows/ci.yml)
...
#### SSH (recommended)
```bash
git clone --recursive git@github.com:Bootstrap-Academy/events-ms.git
```

#### HTTPS
```bash
git clone --recursive https://github.com/Bootstrap-Academy/events-ms.git
```
